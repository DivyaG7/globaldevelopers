    ...
    return (
      ...
      >
        <img src={rightArrow} alt="Next" className="arrow-icon" />
                ...
                <div className="row">
                    ...
                    <div className="col-md-7">
                        ...
                        <p className="mb-4 text-muted">
                            ...
                            support to ensure your experience exceeds expectations.
                        </p>
                        ...
                        <div className="d-flex align-items-center gap-4 p-3 mb-4 rounded">
                            ...
                            <div>
                                ...
                                <p className="mb-0 small">
                                    Global - Icon,<br />
                                    Ground Floor, Plot No. 131/73 New Vellala Street,<br />
            ...
            <div>
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d15547.211402806175!2d80.2455552!3d13.048217600000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1761731712334!5m2!1sen!2sin" style={{ width: '100%', height: '400px' }} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="map"></iframe>
            </div>
        </>
    );
};
